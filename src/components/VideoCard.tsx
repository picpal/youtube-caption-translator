...
export interface VideoCardProps {
   ...
   *
   * `channelName` is rendered the same way regardless of this flag: its own
   * `null` already means "ask again later" independent of the report's
   * overall status.
   */
  loading: boolean;
}
 ...
 * block — thumbnail + duration badge, two-line-clamped title, and channel.
 * Ported 1:1 in structure from the inline markup entrypoints/sidepanel/App.tsx's
 * `ReadyBody` used to hardcode as M0 placeholders (see that file's history /
 * the M0 placeholder table in
