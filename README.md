...
| <img src="docs/images/panel-summary.png" width="260" alt="요약 탭 — 핵심 주장, 발표 흐름, 키워드, 결론"> | **요약**<br>번역과 함께 자동으로 만들어집니다. 문제 제기·핵심 주장·발표 흐름·키워드·결론으로 정리되고, 발표 흐름의 시간을 누르면 영상의 그 지점으로 이동합니다. |
...
4. 다 되면 스크립트가 나타납니다. 영상을 재생하면 알아서 따라 내려가고,
   줄을 누르면 그 지점으로 이동합니다.
5. 위쪽 **Summary** 탭에서 요약을, **Notes** 탭에서 우클릭·☆로 기억해 둔
   문장을 모아 볼 수 있습니다. **내려받기** 아이콘에서 Markdown/PDF 저장은
   물론, 기억한 문장만 따로 Markdown으로 받을 수도 있습니다.
...
| 요약 | 번역과 **동시에** 만들어집니다 — 따로 기다리지 않습니다 |

요약은 원문 자막만 있으면 만들 수 있어서 번역이 끝나기를 기다리지 않고 같이
돕니다. 그래서 번역이 끝나 Summary 탭이 나타날 때는 요약이 이미 준비돼 있습니다.

실제 측정 예 — 22분짜리 영상(자막 142구간)에서 번역 78초, 요약 41초가 **겹쳐서**
돌아 전체 78초에 끝났습니다. 1시간 6분짜리 대담 영상(322구간)의 번역은
**7분 53초** 걸립니다.
...
- **요약이 번역보다 늦게 끝나기도 합니다.** 요약에 걸리는 시간은 영상 길이만
  따라가지 않고 그날 서버 사정을 많이 탑니다 — 같은 22분 영상에서 35초가
  걸린 적도, 5분이 걸린 적도 있습니다. 늦어지면 Summary 탭에 잠깐 빈 화면이
  보였다가 채워집니다. 스크립트는 그동안에도 다 보실 수 있습니다.
