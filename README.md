...
| <img src="docs/images/panel-summary.png" width="260" alt="요약 탭 — 핵심 주장, 발표 흐름, 키워드, 결론"> | **요약**<br>문제 제기·핵심 주장·발표 흐름·키워드·결론으로 정리해 줍니다. 발표 흐름의 시간을 누르면 영상의 그 지점으로 이동합니다. |
...
| 요약 생성 (1시간 영상) | 3~4분, 번역이 끝난 뒤 따로 |

실제 측정 예 — 1시간 6분짜리 대담 영상(자막 322구간)의 번역이 **7분 53초**,
같은 영상의 요약 생성이 **3분 45초** 걸렸습니다.
...
- **긴 영상의 요약은 오래 걸립니다.** 자막 전체를 한 번에 넘겨 요약하기 때문에,
  1시간짜리 영상이면 3~4분 동안 스피너가 돕니다. 그동안 스크립트는 이미 다 보실
  수 있습니다.
